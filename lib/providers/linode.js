    ...
    if (!err) {
      ...
      client.call('linode.create', {DatacenterID: dc.DATACENTERID, PlanID: 1, PaymentTerm: 1}, function (err, res) {
        ...
        if (!err) {
          ...
          client.call('linode.disk.createfromstackscript', {LinodeID: linode_id, StackScriptID: 8878, StackScriptUDFResponses: {}, DistributionID: 127, Label: "fullnode", Size: 24064, rootPass: config.providers.linode.rootpass}, function (err, res) {
...
exports.deleteDisks = function (serverid, callback) {
  logger.warn('deleting disks from ' + serverid);
  client.call('linode.disk.list', {"LinodeID": serverid}, function (err, result) {
    if (err)
      return callback(err);
  ...
  client.call('linode.disk.list', {"LinodeID": serverid}, function (err, result) {
    result.forEach(function (d) {
      var call = function (callback) {
        client.call('linode.disk.delete', {"LinodeID": serverid, "DiskID": d.DISKID}, function (err, result) {
