...
exports.provisionServer = function (callback) {
                        ...
                        if (!err) {
                          client.call('linode.ip.list', {LinodeID: linode_id}, function (err, res) {
                            ...
                            if (!err) {
                              ...
                              return callback(null, res[0].IPADDRESS, dc.LOCATION, linode_id);
                            }
                            else
                              return callback(err);
                          });
...
exports.deleteServer = function (severid, callback) {
  client.call('linode.delete', {"LinodeID": serverid}, function (err, dcs) {
    if (!err)
